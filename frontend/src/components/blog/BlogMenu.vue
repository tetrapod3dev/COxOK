<template>
  <div class="button-container">
    <router-link tag="button" :to="{ name: 'BlogHomeView' }" class="learn-more">
      <i class="far fa-address-card"></i>
      <p class="d-none d-sm-block">내정보</p>
    </router-link>
    <router-link
      tag="button"
    ...
    >
      ...
      <p class="d-none d-sm-block">게시글</p>
    </router-link>
    <router-link
      tag="button"
    ...
    >
      ...
      <p class="d-none d-sm-block">요리책</p>
    </router-link>
    <router-link
      tag="button"
