<template>
  <div class="button-container">
    <router-link tag="button" :to="{ name: 'BlogHomeView' }" class="learn-more">내정보</router-link>
    <router-link
      tag="button"
    ...
    <router-link
      ...
      class="learn-more Katuri"
    >코~옥</router-link>
    <router-link tag="button" :to="{ name: 'UserSettingView' }" class="learn-more Katuri">정보수정</router-link>
  </div>
</template>
